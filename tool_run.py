...
if RESET:
    ...
    def code_assetref(code,skinid):
        ...
        with open(f'./Pmin_Sources/Resources/1.59.1/AssetRefs/Hero/{skinid}_AssetRef.bytes','rb') as f:
            a=decompress_(f.read(),ZSTD_DICT)
            a=a.lower()
            if code in a:
                return True
    ...
    def mod_ef_sound(a,nh,ID,file,folder_mod):
        ...
        if (ID == b'51504' and file in ['A1.xml', 'A2.xml', 'A3.xml', 'A4.xml', 'A5.xml', 'S1.xml', 'S11.xml', 'S12.xml', 'S21B0.xml', 'S21B5.xml', 'S2B0.xml', 'S2B1.xml', 'S2B5.xml', 'U1B0.xml']) or (ID == b'11107' and 'E' not in file and 'eath' not in file)  or (ID == b'12304' and 'E' not in file) or (ID == b'15704' and file in ['S1.xml','A1.xml','A3.xml','A4.xml','S2.xml','U1.xml']):
            ...
            for code in split_code_clipname(a):
                ...
                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Dance.xml','rb') as f:
                    dance = f.read()
                    dance = dance.replace(b'  </Action>',code+b'  </Action>')
                    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Dance.xml','wb') as f1:
                        f1.write(dance)
        a=a.replace(b'        <bool name="bAllowEmptyEffect" value="true" refParamName="" useRefParam="false" />\r\n',b'        <bool name="bAllowEmptyEffect" value="false" refParamName="" useRefParam="false" />\r\n')
    ...
    def ten_skin_hieu_ung(skinid):
        with open('./Pmin_Sources/Resources/1.59.1/Databin/Client/Actor/heroSkin.bytes','rb') as f:
            a=f.read()
            ...
            if p!=-1:
                ...
                if b"Skin_Icon_Skill" in code or b"Skin_Icon_BackToTown" in code or skinid==b'53702' or skinid==13204 or skinid==53702 or skinid == 15305:
                    ...
                    h=b'PminMod'
                    with open(f'./Pmin_Sources/Resources/1.59.1/Databin/Client/Sound/BattleBank.bytes','rb') as f:
                        a=f.read()
                        a=decompress_(a,ZSTD_DICT)
        ...
        a2=''
        if ten!=b'' and skin!=b'':
            for file in os.listdir('./Pmin_Sources/Resources/1.59.1/Languages/VN_Garena_VN'):

                txt=open(f'./Pmin_Sources/Resources/1.59.1/Languages/VN_Garena_VN/{file}','rb')
                a=txt.read()
                a=decompress_(a,ZSTD_DICT)
                p=a.find(ten)
                if p!=-1:
    ...
    def tao(folder_mod):
        if True:
            ...
            for fo in ['commonresource', 'KeySpell', 'PassiveResource', 'mowen', 'Ultrafire', 'SeasonPlay']:
                inp = f'./Pmin_Sources/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/'
                inp2 = f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/'
            ...
            os.mkdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Prefab_Characters/Prefab_Hero'.format(folder_mod))
        ...
        for data in databin:
            for file in name:
                    try:    
                        with open(f'./Pmin_Sources/Resources/1.59.1/Databin/Client/{data}/{file}','rb') as f:
                            strin = f.read()
                            strin=decompress_(strin,ZSTD_DICT)
                            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/{data}/{file}','wb') as f1:
                                f1.write(strin)
                    except:
                            pass
    ...
    for skinid in txt:
        if "%" in skinid:
            ...
            if b'rt' in skinid or b'RT' in skinid:
                ...
                skinid=skinid[:5]
            for hero_name in listdir('./Pmin_Sources/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/'):
            ...
            if skinid[:3] in List_Hero_Da_Mod:# or '[ex]' in tat:
                ...
                if os.path.isdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Prefab_Characters/Prefab_Hero'.format(folder_mod)) == 0 :
                    os.mkdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Prefab_Characters/Prefab_Hero'.format(folder_mod))
                if os.path.isdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress)) == 0 :
                    os.mkdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress))
                for filezz in listdir(f'./Pmin_Sources/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/'):
                    if os.path.isdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,filezz)) == 0 :
                        os.mkdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,filezz))
                if os.path.isdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress)) == 0 :
                    os.mkdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress))
                ...
                try:
                    ...
                    print('Mod Sound')
                    if True:
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Sound/BattleBank.bytes','rb') as f:
                            strin = f.read()
                            ...
                            if pos!=-1:
                                ...
                                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Sound/BattleBank.bytes','wb') as f1:
                                    f1.write(strin)
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Sound/ChatSound.bytes','rb') as f:
                            strin = f.read()
                            ...
                            if pos!=-1:
                                ...
                                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Sound/ChatSound.bytes','wb') as f:
                                    f.write(strin)
                        find_back=0
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Sound/HeroSound.bytes','rb') as f:
                            strin = f.read()
                            ...
                            if pos!=-1:
                                strin = strin.replace(b'\x00'+id_0+b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',b'\x00\xff\xff\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
                                strin = strin.replace(b'\x00'+id_mod+b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',b'\x00'+id_0+b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
                                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Sound/HeroSound.bytes','wb') as f:
                                    f.write(strin)  
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Sound/LobbyBank.bytes','rb') as f:
                            strin = f.read()
                            ...
                            if pos!=-1:
                                ...
                                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Sound/LobbyBank.bytes','wb') as f1:
                                    f1.write(strin)
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Sound/LobbySound.bytes','rb') as f:
                            strin = f.read()
                            pos = strin.find(b'\x00'+id_mod + b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
                            if pos!=-1:
                                strin = strin.replace(b'\x00'+id_0+b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',b'\x00\xff\xff\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
                                strin = strin.replace(b'\x00'+id_mod+b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',b'\x00'+id_0+b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
                                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Sound/LobbySound.bytes','wb') as f1:
                                    f1.write(strin)
            ...
            #-----------------------------------------------Mod Skill Mark------------------------------------------------------------#
                ...
                try:
                    ...
                    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Skill/skillmark.bytes','rb') as f:
                        a=f.read()
                        ...
                        if b's/'+skinid[:3]+b'_' in a or b'S/'+skinid[:3]+b'_' in a:
                            ...
                            while p!=-1:
                                ...
                                p=a.find(t,p2)
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Skill/skillmark.bytes','wb') as f1:
                            f1.write(a)
                except:
            ...
            #-----------------------------------------------Mod Effect------------------------------------------------------------#
                                ...
                                for file in listdir('./Pmin_Sources/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{}/skill/'.format(decompress)):
                                    if True:
                                        try:
                                            ...
                                            with open(f'./Pmin_Sources/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','rb') as f:
                                                strin = f.read()
                                                strin=decompress_(strin,ZSTD_DICT)
                                    ...
                                    if DeAllSkin:
                                        ...
                                        import random
                                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','rb') as f1:
                                            text=f1.read()
                                        ...
                                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','wb') as f1:f1.write(text)
                                if check_skill_an:
                                    ten_de_vao_skill_an=ten_de_vao_skill_an+decompress+'\n'
                                    for i in list_skill_an:
                                        ten_de_vao_skill_an=ten_de_vao_skill_an+'\t'+i+'\n'
                            else:
                                for file in listdir(f'./Pmin_Sources/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/{filez}'):
                                    with open(f'./Pmin_Sources/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/{filez}/{file}','rb') as f:
                                        strin = f.read()
                                    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/{filez}/{file}','wb') as f1:
                                                f1.write(strin)
                    else:
                        for file in listdir('./Pmin_Sources/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{}/skill/'.format(decompress)):
                            if '.xml' in file:
                ...
                if hieu_ung == b'\x8f' and not DeAllSkin and False:
                    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Born.xml','rb') as f1:
                        strin=f1.read()
                    ...
                    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Born.xml','wb') as f1:
                        f1.write(strin)
            #-----------------------------------------------Mod heroSkin------------------------------------------------------------#
                try:
                    if True:
                        ...
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Actor/heroSkin.bytes','rb') as f:
                            ...
                            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Actor/heroSkin.bytes','wb') as f1:
                                f1.write(strin)
                except Exception as bug:
                    print(bug)
                                ...
                                if pos !=-1:
                                    ...
                                    if re_2!=b'' and actor_2!=b'' and nnn!=int(skinid[3:].decode()):
                                        ...
                                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Actor/heroSkin.bytes','wb') as f1:
                                            f1.write(strin)
                        try:
                            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Shop/HeroSkinShop.bytes','rb') as f:
                                strin = f.read()
                                hero_actor=dec_to_hex(int(skinid[:3].decode()))
                                pos = strin.find(id_2+b'\x00\x00'+hero_actor)
                                if pos !=-1:
                                    ...
                                    if pos!=-1:
                                        ...
                                        if skinid==b'13311' or skinid==b'11620':
                                            with open(f'./Pmin_Sources/Resources/1.59.1/Databin/Client/Shop/HeroSkinShop.bytes','rb') as f:
            ...
            #-----------------------------------------------Mod Infos Skin Mặc Định------------------------------------------------------------#
                ...
                for file in listdir('./Pmin_Sources/Resources/1.59.1/Prefab_Characters/Prefab_Hero/{}/'.format(decompress)):
                    with open(f'./Pmin_Sources/Resources/1.59.1/Prefab_Characters/Prefab_Hero/{decompress}/{file}','rb') as f:
                        a=f.read()
                        check_file3=False
                        ...
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Prefab_Characters/Prefab_Hero/{decompress}/{file}','wb') as f1:
                            f1.write(a)
                thu=False
                try:
                    filexml='./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,file2)
                    byt=open(filexml, 'rb')
                    i=0
                    nod={}
                    ofs = getint()
                ...
                if thu:
                    try:
                        with open(f'./Pmin_Sources/Resources/1.59.1/Prefab_Characters/Prefab_Hero/{decompress}/{file2}','rb') as f:
                            strin=f.read()
                            strin=decompress_(strin,ZSTD_DICT)
                            ...
                            if cam_skin_find!=-1:
                                ...
                                strin=strin.replace(mac_dinh,mac_dinh.replace(lod_mac_dinh,lod_skin).replace(show_mac_dinh,show_skin))
                            with open('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,file2),'wb') as f1:
                                if skinid==b'54402':
                ...
                try:
                    if check_file3:
                        filexml='./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,file3)
                        byt=open(filexml, 'rb')
                        i=0
                        nod={}
                        ofs = getint()
            ...
            #-----------------------------------------------Mod Back------------------------------------------------------------#
                ...
                if skinid in id_back and may_yeu_mod:# ((check_bien_ve_ef or skinid in [b'15004',b'13311',b'16707',b'11620']) or ) and may_yeu_mod:
                    try:
                        ...
                        try:
                            with open(f'./Pmin_Sources/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{skinid.decode()}_back.xml','rb') as f:
                                strin = f.read()
...
'''
                        if True:
                            if True:
                                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/back.xml','rb') as f:
                                    strin = f.read()
                                    if True:
                                        ...
                                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Back.xml','wb') as f1:
                                            f1.write(strin)
                        zz+=1;i+=1;j+=1
                    except Exception as bug:
                        print(bug)
            ...
            #-----------------------------------------------Mod LiteBullet------------------------------------------------------------#
                ...
                if skinid in [b"50108",b"14111",b"13314",b"11107",b"15009",b"13015"]:
                    def organSkin(IDCHECK,folder_mod=folder_mod):
                        ID = IDCHECK
                        organSkin_mod=f"File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Actor/organSkin.bytes"
    ...
    #------------------------mod ăn bùa nak----------------------
                if skinid[:3]==b'150':
                    ...
                    for file in ['Dead_Born.xml']:
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/{file}','rb') as f:
                            a=f.read()
    ...
    #------------------------mod ăn bùa nak----------------------
                ...
                def mod_lite(folder_mod,hero_name,skinid):
                    try:
                        ...
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Skill/liteBulletCfg.bytes','rb') as f:
                            strin = f.read()
                            k=0
                                        ...
                                        if pos!=-1:
                                            ...
                                            if pos!=-1:
                                                ...
                                                if pos!=-1:
                                                    ...
                                                    a=a.replace(a,dau+a[1:])
                                                    strin = strin.replace(re_a,a)
                                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Skill/liteBulletCfg.bytes','wb') as f1:
                                            f1.write(strin)
                                        k+=1
                    except:
                ...
                if b'/'+skinid[:3]+b'_' in a and hieu_ung==b'\x8f':
                    if skinid!=b'13311':
                        ...
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Skill/liteBulletCfg.bytes','wb') as f:f.write(a)


                        #-mod aov-
                if skinid==b'13311':
                    inp = f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/'
                ...
                if skinid==b'16707':
                    ...
                    for file in listdir('./Pmin_Sources/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{}/skill/'.format(decompress)):
                        if '.xml' in file:
                            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','rb') as f:
                ...
                try:
                    if True:
                        ...
                        if skinid[:3]==b'526' or skinid[:3]==b'137':
                            ...
                            with open(f'./Pmin_Sources/Resources/1.59.1/Prefab_Characters/Prefab_Pet/{decompress}_Pet/{decompress}_Pet_actorinfo.bytes','rb') as f:a=f.read()
                            if skinid[:3]==b'526':
                                a=decompress_(a,ZSTD_DICT)
                            ...
                            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Prefab_Characters/{decompress}_pet/{decompress}_Pet_actorinfo.bytes','wb') as f:f.write(a)
                            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Prefab_Characters/Prefab_Hero/{decompress}/{decompress}_actorinfo.bytes','rb') as f:
                                a=f.read()
                                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Prefab_Characters/{decompress}/{decompress}_actorinfo.bytes','wb') as f:
                                    f.write(a)
                            def zipdir3(path, ziph):
                                for ii in [decompress,f'{decompress}_pet']:
                                    nonee = './{}'.format(ii)
                                    DIR2 = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Prefab_Characters/{}'.format(folder_mod,ii)
                                    DIR = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Prefab_Characters/{}'.format(folder_mod,ii)
                                    for root, dirs, files in os.walk(DIR):
                                        for file in files:
                                            full_path = os.path.join(root, file)
                                            arcname = os.path.relpath(full_path, os.path.join(DIR, '..'))
                                            ziph.write(full_path,arcname)
                            with zipfile.ZipFile('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Prefab_Characters/Actor_{}_Infos.pkg.bytes'.format(folder_mod,decompress[:3]), 'w', zipfile.ZIP_STORED) as zipf:
                                zipdir3('tmp/', zipf)
                            for file in listdir(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Prefab_Characters/'):
                                if 'bytes' not in file:
                                    shutil.rmtree(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Prefab_Characters/{file}')
                        if skinid[:3]!=b'526' and skinid[:3]!=b'137':
                            DIR = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress)
                            DIR2 = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress)
                            nonee = './Prefab_Hero/{}'.format(decompress)
                            with zipfile.ZipFile('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Prefab_Characters/Actor_{}_Infos.pkg.bytes'.format(folder_mod,hero_name[:3].decode()), 'w', zipfile.ZIP_STORED) as zipf:
                                zipdir('tmp/', zipf)
                        if os.path.isdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress))== 1 :
                            shutil.rmtree('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress))
                        if skinid[:3]!=b'526' and skinid[:3]!=b'137':
                            if os.path.isdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Prefab_Characters/Prefab_Hero'.format(folder_mod))== 1 :
                                shutil.rmtree('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Prefab_Characters/Prefab_Hero'.format(folder_mod))
                except:pass
            #----------------------------------Mod Motion--------------------------------------------#
                print('Mod Motion')
                try:
                    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Motion/ResSkinMotionBaseCfg.bytes','rb') as f:
                        strin=f.read()
                        ID=skinid.decode()
                        List=[]
                        for i in range(30):
                        ...
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Motion/ResSkinMotionBaseCfg.bytes','wb') as f:f.write(strin)
                except:
                    print('\033[1;33mKhong Mod Motion')
                if skinid in [b'54402']:
                    if os.path.isdir(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Gear')== 0 :
                        shutil.copytree(f'./Pmin_Sources/resources/1.59.1/ages/prefab_gear',f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Gear')
                    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Gear/Defense/1338E1.xml','rb') as f:
                        strin=f.read()
                        strin=decompress_(strin,ZSTD_DICT)
                        ...
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Gear/Defense/1338E1.xml','wb') as f:
                            f.write(fix_condition(strin))
                    def zipdir6(path, ziph):
                        DIR = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Gear'.format(folder_mod)
                        for root, dirs, files in os.walk(DIR):
                            for file in files:
                                full_path = os.path.join(root, file)
                                arcname = os.path.relpath(full_path, os.path.join(DIR, '..'))
                                ziph.write(full_path,arcname)
                    with zipfile.ZipFile(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Gear.pkg.bytes', 'w', zipfile.ZIP_STORED) as zipf:
                        zipdir6('tmp/', zipf)
                    shutil.rmtree(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Gear')
                ...
                try:
                    ...
                    if True:#find_back>2 and may_yeu_mod and check_bien_ve_ef:
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1.xml','rb') as f:
                            strin = f.read()
                            ...
                            if pos!=-1:
                                ...
                                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1.xml','wb') as f1:
                                    f1.write(strin)
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1_leave.xml','rb') as f:
                            strin = f.read()
                            for code in split_code_back(strin[:strin.find(b'    <Track trackName="CheckHeroId')]):
                                code_goc=code
                                check_Back=b'</Event>'
                ...
                try:
                    if skinid[:3] in [b'150']:
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Huanhua/ResKillBillboardCfg.bytes','rb') as f:
                            killboard=f.read()
                        ...
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Huanhua/ResKillBillboardCfg.bytes','wb') as f:
                            f.write(killboard)
                except Exception as bug:
                    print(bug)
                #Mod assetrefs
                ...
                try:
                    if True:   
                        ...
                        with open(f'./Pmin_Sources/Resources/1.59.1/AssetRefs/Hero/{file}','rb') as f:
                            strin = f.read()
                            strin=decompress_(strin,ZSTD_DICT)
                            if os.path.isdir(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/AssetRefs/') ==0:
                                os.makedirs(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/AssetRefs/')
                                os.makedirs(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/AssetRefs/Hero/')
                            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/AssetRefs/Hero/{file}','wb') as f1:
                                f1.write(strin)
                        filexml=f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/AssetRefs/Hero/{file}'
                        byt=open(filexml, 'rb')
                        i=0
                        nod={}
                        ofs = getint()
    ...
    def zipdir2(path, ziph):
        for ii in back_folder:
            DIR2 = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,ii)
            DIR = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,ii)
            for root, dirs, files in os.walk(DIR):
                for file in files:
                    full_path = os.path.join(root, file)
                    arcname = os.path.relpath(full_path, os.path.join(DIR, '..'))
                    ziph.write(full_path,arcname)
    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Back.xml','rb') as f1:strin=f1.read()
    ...
    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1.xml','rb') as f1:strin=f1.read()
    ...
    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1.xml','wb') as f1:
        strin=xoa_thua_thai(strin)
        f1.write(compress_(strin,ZSTD_DICT))
    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1_leave.xml','rb') as f1:strin=f1.read()
    if False:
    ...
    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1_leave.xml','wb') as f1:
        strin=xoa_thua_thai(strin)
        f1.write(compress_(strin,ZSTD_DICT))
    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Born.xml','rb') as f1:strin=f1.read()
    strin=fix_condition(strin)
    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Born.xml','wb') as f1:
        strin=xoa_thua_thai(strin)
        f1.write(compress_(strin,ZSTD_DICT))
    with zipfile.ZipFile('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/CommonActions.pkg.bytes'.format(folder_mod), 'w', zipfile.ZIP_STORED) as zipf:
        zipdir2('tmp/', zipf)
    ...
    for iii in back_folder:
        if os.path.isdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,iii))== 1 :
            shutil.rmtree('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,iii))
    #---------mod ResCharacterComponent.bytes-----
    try:
        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Character/ResCharacterComponent.bytes','rb') as f:
            a=f.read()
            p2=a[:14]
            p3=a[:12]+b'\x00\x00'
            a=a.replace(p2,p3,1)
            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/Databin/Client/Character/ResCharacterComponent.bytes','wb') as f:f.write(compress_(a,ZSTD_DICT))
    except:
            ...
            for file in listdir('NutBam'):
                if nut_bam in file:
                    with open(f'Nutbam/{file}','rb') as f:
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.59.1/assetbundle/uisystem/atlas/primary/allshared.assetbundle','wb') as f2:
                            f2.write(f.read())
                    break
    except Exception as bug:
        pass
    ...
    if cam_xa_goc!=100:
        ...
        giai_nen(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/','CommonActions.pkg.bytes')
        with open(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak/skill/P2E1.xml','rb') as f:
            a=f.read()
            a=decompress_(a,ZSTD_DICT)
            p=a.find(b'<Track trackName="')
            a=a[:p]+cam_xa
            with open(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak/skill/P2E1.xml','wb') as f:f.write(compress_(a,ZSTD_DICT))
        with open(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/back.xml','rb') as f:
            a=f.read()
            a=decompress_(a,ZSTD_DICT)
            a=a.replace(b'</Action>',hittringer_dirak)
            with open(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/back.xml','wb') as f:f.write(compress_(a,ZSTD_DICT))
        with open(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/born.xml','rb') as f:
            a=f.read()
            a=decompress_(a,ZSTD_DICT)
            a=a.replace(b'</Action>',hittringer_dirak)
            with open(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/born.xml','wb') as f:f.write(compress_(a,ZSTD_DICT))
        with open(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Heal5v5.xml','rb') as f:
            a=f.read()
            a=decompress_(a,ZSTD_DICT)
            a=a.replace(b'</Action>',hittringer_dirak)
            with open(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Heal5v5.xml','wb') as f:f.write(compress_(a,ZSTD_DICT))
        with open(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Heal3v3.xml','rb') as f:
            a=f.read()
            a=decompress_(a,ZSTD_DICT)
            a=a.replace(b'</Action>',hittringer_dirak)
            with open(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Heal3v3.xml','wb') as f:f.write(compress_(a,ZSTD_DICT))
        DIR = f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak/skill'
        DIR2 = f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak/skill'
        nonee = './530_Dirak/skill'
        with zipfile.ZipFile(f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/Actor_530_Actions.pkg.bytes', 'w', zipfile.ZIP_STORED) as zipf:
            zipdir('tmp/', zipf)
        def zipdir_camxa(path, ziph):
            for ii in back_folder:
                nonee = './{}'.format(ii)
                DIR2 = f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{ii}'
                DIR = f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{ii}'
                for root, dirs, files in os.walk(DIR):
                    for file in files:
                        full_path = os.path.join(root, file)
                        arcname = os.path.relpath(full_path, os.path.join(DIR, '..'))
                        ziph.write(full_path,arcname)
        with zipfile.ZipFile(f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/CommonActions.pkg.bytes', 'w', zipfile.ZIP_STORED) as zipf:
            zipdir_camxa('tmp/', zipf)
        if os.path.isdir(f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak')== 1 :
            shutil.rmtree(f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak')
        for iii in back_folder:
            if os.path.isdir(f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{iii}')== 1 :
                shutil.rmtree(f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.59.1/Ages/Prefab_Characters/Prefab_Hero/{iii}')
    if nut_bam_auto_mod!='':
