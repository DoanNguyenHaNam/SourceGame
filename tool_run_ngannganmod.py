...
if True:
    ...
    try:
        ...
        try:
            os.system('python -m pip install pyzstd==0.15.4')
            ...
            os.system('pip install pyzstd==0.15.4')
    ...
    print('------- KIỂM TRA TÍNH HOÀN CHỈNH CỦA TÀI NGUYÊN --------')
    try:
        with open(f'Input Text/back.txt','rb') as f:
            id_back = [line for line in f.read().split(b'\n') if line]
    except:
        id_back = []
    try:
        with open(f'Input Text/haste.txt','rb') as f:
    ...
    def split_code_infos_a(a):
        ...
        while p!=-1:
            ...
            p=a.find('\n      <Item Var="Com" Type="Assets.Scripts.GameLogic.SkinElement">\n         ',p2)
        return z
    def mod_infos_mac_dinh(a,skinid,List, SoInfos = 0):
        if skinid=='13311':
            a=  a.replace(
    ...
    def code_assetref(code,skinid):
        ...
        with open(f'./Pmin_Sources/Resources/1.62.1/AssetRefs/Hero/{skinid}_AssetRef.bytes','rb') as f:
            a=decompress_(f.read(),ZSTD_DICT)
            a=a.lower()
            if code in a:
                return True
    ...
    def fix_ef_infos(a,nh,ID):
        a=mod_ef_sound2(a.encode('utf-8'),nh,ID.encode('utf-8')).decode()
        z=[]
    ...
    def mod_ef_sound(a,nh,ID,file,folder_mod):
        ...
        if (ID == b'51504' and file in ['A1.xml', 'A2.xml', 'A3.xml', 'A4.xml', 'A5.xml', 'S1.xml', 'S11.xml', 'S12.xml', 'S21B0.xml', 'S21B5.xml', 'S2B0.xml', 'S2B1.xml', 'S2B5.xml', 'U1B0.xml']) or (ID == b'11107' and 'E' not in file and 'eath' not in file)  or (ID == b'12304' and 'E' not in file) or (ID == b'15704' and file in ['S1.xml','A1.xml','A3.xml','A4.xml','S2.xml','U1.xml']):
            ...
            for code in split_code_clipname(a):
                ...
                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Dance.xml','rb') as f:
                    dance = f.read()
                    dance = dance.replace(b'  </Action>',code+b'  </Action>')
                    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Dance.xml','wb') as f1:
                        f1.write(dance)
        a=a.replace(b'        <bool name="bAllowEmptyEffect" value="true" refParamName="" useRefParam="false" />\r\n',b'        <bool name="bAllowEmptyEffect" value="false" refParamName="" useRefParam="false" />\r\n')
    ...
    def infoAboutSkin(skinid: bytes):
        with open('./Pmin_Sources/Resources/1.62.1/Databin/Client/Actor/heroSkin.bytes','rb') as f:
            ...
            for i in range(1, 30):
                ...
                p=a.find(dec_to_hex(int(ID.decode()))+b'\x00\x00'+dec_to_hex(int(ID[:3].decode())))
                if p!=-1:
                    code=a[p-4:p+hex_to_dec(a[p-4:p-2])]
                    if b'Share' in code:
    ...
    def tao(folder_mod):
        if True:
            ...
            for fo in ['commonresource', 'KeySpell', 'PassiveResource', 'mowen', 'Ultrafire', 'SeasonPlay']:
                inp = f'./Pmin_Sources/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/'
                inp2 = f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/'
                ...
                if fo != 'SeasonPlay':
                    ...
                    # SeasonPlay: copy toàn bộ nội dung (file + folder) từ src_dir sang dst_dir
                    if os.path.exists(dst_dir):
                        shutil.rmtree(dst_dir)
                    shutil.copytree(src_dir, dst_dir)
            os.mkdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Prefab_Characters/Prefab_Hero'.format(folder_mod))
        ...
        for data in databin:
            for file in name:
                    try:    
                        with open(f'./Pmin_Sources/Resources/1.62.1/Databin/Client/{data}/{file}','rb') as f:
                            strin = f.read()
                            strin=decompress_(strin,ZSTD_DICT)
                            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/{data}/{file}','wb') as f1:
                                f1.write(strin)
                    except:
                            pass
        for file in ['ResAwakenBattleSound.bytes','ResAwakenBattleEffect.bytes']:
            ...
            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Actor/{file}','wb') as f1:
                f1.write(text)
        return back_need_
    ten_de_vao_ten=''
    ...
    for skinid in txt:
        ...
        if "%" in skinid:
            ...
            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Languages/VN_Garena_VN/languageMap.txt','rb') as f:
                strin=(f.read())
            ...
            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Languages/VN_Garena_VN/languageMap.txt','wb') as f:
                f.write((strin))
            ...
            if b'rt' in skinid or b'RT' in skinid:
                phu_kien=True
                skinid=skinid[:5]
            for hero_name in listdir('./Pmin_Sources/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/'):
            ...
            if skinid[:3] in List_Hero_Da_Mod:# or '[ex]' in tat:
                ...
                if os.path.isdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Prefab_Characters/Prefab_Hero'.format(folder_mod)) == 0 :
                    os.mkdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Prefab_Characters/Prefab_Hero'.format(folder_mod))
                if os.path.isdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress)) == 0 :
                    os.mkdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress))
                for filezz in listdir(f'./Pmin_Sources/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/'):
                    if os.path.isdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,filezz)) == 0 :
                        os.mkdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,filezz))
                if os.path.isdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress)) == 0 :
                    os.mkdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress))
                ...
                try:
                    ...
                    print('Mod Sound')
                    if True:
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Sound/BattleBank.bytes','rb') as f:
                            strin = f.read()
                            ...
                            if pos!=-1:
                                ...
                                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Sound/BattleBank.bytes','wb') as f1:
                                    f1.write(strin)
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Sound/ChatSound.bytes','rb') as f:
                            strin = f.read()
                            ...
                            if pos!=-1:
                                ...
                                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Sound/ChatSound.bytes','wb') as f:
                                    f.write(strin)
                        find_back=0
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Sound/HeroSound.bytes','rb') as f:
                            strin = f.read()
                            ...
                            if pos!=-1:
                                strin = strin.replace(b'\x00'+id_0+b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',b'\x00\xff\xff\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
                                strin = strin.replace(b'\x00'+id_mod+b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',b'\x00'+id_0+b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
                                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Sound/HeroSound.bytes','wb') as f:
                                    f.write(strin)  
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Sound/LobbyBank.bytes','rb') as f:
                            strin = f.read()
                            ...
                            if pos!=-1:
                                ...
                                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Sound/LobbyBank.bytes','wb') as f1:
                                    f1.write(strin)
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Sound/LobbySound.bytes','rb') as f:
                            strin = f.read()
                            pos = strin.find(b'\x00'+id_mod + b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
                            if pos!=-1:
                                strin = strin.replace(b'\x00'+id_0+b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',b'\x00\xff\xff\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
                                strin = strin.replace(b'\x00'+id_mod+b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',b'\x00'+id_0+b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
                                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Sound/LobbySound.bytes','wb') as f1:
                                    f1.write(strin)
            ...
            #-----------------------------------------------Mod Skill Mark------------------------------------------------------------#
                ...
                try:
                    ...
                    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Skill/skillmark.bytes','rb') as f:
                        a=f.read()
                        ...
                        if b's/'+skinid[:3]+b'_' in a or b'S/'+skinid[:3]+b'_' in a:
                            ...
                            while p!=-1:
                                ...
                                p=a.find(t,p2)
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Skill/skillmark.bytes','wb') as f1:
                            f1.write(a)
                except:
            ...
            #-----------------------------------------------Mod Effect------------------------------------------------------------#
                ...
                if True:
                    ...
                    if hieu_ung == b'\x8f':
                        ...
                        with open(f'./Pmin_Sources/Resources/1.62.1/AssetRefs/Hero/{decompress[:3]}_AssetRef.bytes','rb') as asef:
                            check_asef=fix_ef(mod_ef_sound2(decompress_(asef.read()),decompress,skinid),skinid).lower()
                        for filez in listdir(f'./Pmin_Sources/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}'):
                            if filez=='skill' or filez=='Skill':
                                for file in listdir('./Pmin_Sources/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}/skill/'.format(decompress)):
                                    source_path = f'./Pmin_Sources/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}'
                                    dest_path = f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}'
                                    ...
                                    if True:
                                        if skinid in accept_ids:
                                            try:
                                                ...
                                                with open(f'./Pmin_Sources/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','rb') as f:
                                                    strin = f.read()
                                                    strin=decompress_(strin,ZSTD_DICT)
                                        ...
                                        #
                                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','wb') as f1:
                                    ...
                                    if DeAllSkin:
                                        ...
                                        import random
                                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','rb') as f1:
                                            text=f1.read()
                                        ...
                                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','wb') as f1:f1.write(text)
                                if check_skill_an:
                                    ten_de_vao_skill_an=ten_de_vao_skill_an+decompress+'\n'
                                    for i in list_skill_an:
                                        ten_de_vao_skill_an=ten_de_vao_skill_an+'\t'+i+'\n'
                            else:
                                for file in listdir(f'./Pmin_Sources/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/{filez}'):
                                    with open(f'./Pmin_Sources/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/{filez}/{file}','rb') as f:
                                        strin = f.read()
                                    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/{filez}/{file}','wb') as f1:
                                                f1.write(strin)
                    else:
                        for file in listdir('./Pmin_Sources/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}/skill/'.format(decompress)):
                            if '.xml' in file:
                ...
                if hieu_ung == b'\x8f' and not DeAllSkin and False:
                    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Born.xml','rb') as f1:
                        strin=f1.read()
                    ...
                    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Born.xml','wb') as f1:
                        f1.write(strin)
            #-----------------------------------------------Mod heroSkin------------------------------------------------------------#
                try:
                    if True:
                        ...
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Actor/heroSkin.bytes','rb') as f:
                            strin = f.read()
                            ...
                            if pos!=-1:
                                ...
                                if pos !=-1:
                                    actor_0 = strin[pos-4:pos+hex_to_dec(strin[pos-4:pos-2])]
                                    ...
                                    if skinid==b'16707':
                                        ...
                                        nhanDangId_mod = actor_mod[64:]
                                        dem = hex_to_dec(nhanDangId_0[:2])

                                        actor_mod = actor_mod[:64] + nhanDangId_0 + actor_mod[64+hex_to_dec(actor_mod[64:66])+4:]
                                        #actor_mod = actor_mod.replace(nhanDangId_mod, nhanDangId_0)
                            ...
                            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Actor/heroSkin.bytes','wb') as f1:
                                f1.write(strin)
                except Exception as bug:
                    print(bug)
                                    ...
                                    if re_2!=b'' and actor_2!=b'' and nnn!=int(skinid[3:].decode()):
                                        ...
                                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Actor/heroSkin.bytes','wb') as f1:
                                            # if str(int(skinid[:3].decode())*100+nnn).encode('utf-8') not in List_ef_mod:
                                                f1.write(strin)
                        try:
                            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Shop/HeroSkinShop.bytes','rb') as f:
                                strin = f.read()
                                hero_actor=dec_to_hex(int(skinid[:3].decode()))
                                pos = strin.find(id_2+b'\x00\x00'+hero_actor)
                                if pos !=-1:
                                    ...
                                    if pos!=-1:
                                        ...
                                        if skinid==b'13311' or skinid==b'11620':
                                            with open(f'./Pmin_Sources/Resources/1.62.1/Databin/Client/Shop/HeroSkinShop.bytes','rb') as f:
                            ...
                            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Shop/HeroSkinShop.bytes','wb') as f1:
                                f1.write(strin)
            ...
            #-----------------------------------------------Mod Infos Skin Mặc Định------------------------------------------------------------#
                ...
                for file in listdir('./Pmin_Sources/Resources/1.62.1/Prefab_Characters/Prefab_Hero/{}/'.format(decompress)):
                    with open(f'./Pmin_Sources/Resources/1.62.1/Prefab_Characters/Prefab_Hero/{decompress}/{file}','rb') as f:
                        a=f.read()
                        check_file3=False
                        ...
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Prefab_Characters/Prefab_Hero/{decompress}/{file}','wb') as f1:
                            f1.write(a)
                thu=False
                try:
                    filexml='./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,file2)
                    byt=open(filexml, 'rb')
                    i=0
                    nod={}
                    ofs = getint()
                ...
                if thu:
                    try:
                        with open(f'./Pmin_Sources/Resources/1.62.1/Prefab_Characters/Prefab_Hero/{decompress}/{file2}','rb') as f:
                            strin=f.read()
                            strin=decompress_(strin,ZSTD_DICT)
                            ...
                            if cam_skin_find!=-1:
                                ...
                                strin=strin.replace(mac_dinh,mac_dinh.replace(lod_mac_dinh,lod_skin).replace(show_mac_dinh,show_skin))
                            with open('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,file2),'wb') as f1:
                                if skinid==b'54402':
                ...
                try:
                    if check_file3:
                        filexml='./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,file3)
                        byt=open(filexml, 'rb')
                        i=0
                        nod={}
                        ofs = getint()
            ...
            #-----------------------------------------------Mod HeroSkinShop------------------------------------------------------------#
                ...
                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Actor/heroSkin.bytes','rb') as f:
                    ...
                    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Actor/heroSkin.bytes','wb') as f:f.write(a)
            #-----------------------------------------------Mod Back------------------------------------------------------------#
                print('mod back')
                name = b''
                if skinid in id_back and may_yeu_mod:# ((check_bien_ve_ef or skinid in [b'15004',b'13311',b'16707',b'11620']) or ) and may_yeu_mod:
                    try:
                        ...
                        try:
                            with open(f'./Pmin_Sources/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{skinid.decode()}_back.xml','rb') as f:
                                strin = f.read()
                            ...
                            pass
                        name=fix_ef(mod_ef_sound2(b''.join(List), decompress, skinid), skinid)
                        if skinid == b'15412':
...
'''
                        if True:
                            if True:
                                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/back.xml','rb') as f:
                                    strin = f.read()
                                    if True:
                                        ...
                                        back_id = condition_mod = condition_mod_false = b''
                                        ...
                                        for ID in List_SkinIfosMod:
                                            if ID not in list_mod_back_error and not bool_hieu_ung(int(ID.decode())):
                                        ...
                                        for code in split_code_back(strin[:strin.find(b'<Track trackName="Zalo_0357514770')]):
                                            ...
                                            if b'GetHolidayResourcePathTick' in code and b'SkinAvatarFilterType="9"' not in code:
                                                ...
                                                strin=strin.replace(code_goc, code)
                                                dem+=1
                                            elif (b'resourceName' not in code and b'<SkinOrAvatarList id="' + skinid in code):
                                                #code=code.replace(b'value="" refParamName="strReturnCityEffectPath" useRefParam="true" />',b'value="Prefab_Skill_Effects/Inner_Game_Effect/returncity_holidays/Holiday0/huicheng_tongyong" refParamName="" useRefParam="false" />')
                                                #code=code.replace(b'value="" refParamName="strReturnCityFall" useRefParam="true" />',b'value="Prefab_Skill_Effects/Inner_Game_Effect/returncity_holidays/Holiday0/huijidi" refParamName="" useRefParam="false" />')
                                        ...
                                        back=back+name+back_need_2.replace(b'<Event eventName="PlayAnimDuration"',condition_mod+b'\r\n      <Event eventName="PlayAnimDuration"')
                                        back = add_filter_attribute(back, b'9')
                                        back=back.replace(b'</Event>', check_Back)
                                        strin = strin.replace(b'  </Action>',back+b'  </Action>')
                                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Back.xml','wb') as f1:
                                            f1.write(strin)
                        zz+=1;i+=1;j+=1
                    except Exception as bug:
                        print(bug)
            ...
            #-----------------------------------------------Mod LiteBullet------------------------------------------------------------#
                ...
                if skinid==b'15009':
                    for file in ['BlueBuff.xml','RedBuff_Slow.xml']:
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/PassiveResource/{file}','rb') as f:
                            a=f.read()
                            a=a.replace(b'CheckSkinIdVirtualTick',b'CheckHeroIdTick').replace(b'skinId" value="15009',b'heroId" value="150')
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/PassiveResource/{file}','wb') as f:
                            f.write(a)
                print('mod organ')
                if skinid in [b"50108",b"14111",b"13314",b"11107",b"15009",b"13015"]:
                    def organSkin(IDCHECK,folder_mod=folder_mod):
                        ID = IDCHECK
                        organSkin_mod=f"File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Actor/organSkin.bytes"
    ...
    #------------------------mod ăn bùa nak----------------------
                if skinid[:3]==b'150':
                    ...
                    for file in ['Dead_Born.xml']:
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/{file}','rb') as f:
                            a=f.read()
                        ...
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/{file}','wb') as f:
                            f.write(a)
    #------------------------mod ăn bùa nak----------------------
                ...
                def mod_lite(folder_mod,hero_name,skinid):
                    try:
                        ...
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Skill/liteBulletCfg.bytes','rb') as f:
                            strin = f.read()
                            k=0
                                        ...
                                        if pos!=-1:
                                            ...
                                            if pos!=-1:
                                                ...
                                                if pos!=-1:
                                                    ...
                                                    a=a.replace(a,dau+a[1:])
                                                    strin = strin.replace(re_a,a)
                                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Skill/liteBulletCfg.bytes','wb') as f1:
                                            f1.write(strin)
                                        k+=1
                    except:
                        print(Fore.RED+Style.BRIGHT+'Không Mod Đánh Thường'+Style.RESET_ALL)
                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Skill/liteBulletCfg.bytes','rb') as f:a=f.read()
                ...
                if b'/'+skinid[:3]+b'_' in a and hieu_ung==b'\x8f':
                    if skinid!=b'13311':
                        ...
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Skill/liteBulletCfg.bytes','wb') as f:f.write(a)


                        #-mod aov-
                if skinid==b'13311':
                    inp = f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/'
                ...
                if skinid==b'16707':
                    ...
                    for file in listdir('./Pmin_Sources/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}/skill/'.format(decompress)):
                        if '.xml' in file:
                            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','rb') as f:
                ...
                try:
                    if True:
                        # if not os.path.isdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}/imprint'.format(folder_mod,decompress)) and  not os.path.isdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}/imprint'.format(folder_mod,decompress)):
                        #     DIR = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}/skill'.format(folder_mod,decompress)
                        #     DIR2 = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}/skill'.format(folder_mod,decompress)
                        #     nonee = './{}/skill'.format(decompress)
                        #     with zipfile.ZipFile('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/Actor_{}_Actions.pkg.bytes'.format(folder_mod,hero_name[:3].decode()), 'w', zipfile.ZIP_STORED) as zipf:
                        #         zipdir('tmp/', zipf)
                        # else:
                        def zipdir4(path, ziph):
                            for ii in listdir(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/'):
                                nonee = f'./{decompress}/{ii}'
                                DIR = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,ii)
                                DIR2 = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,ii)
                                for root, dirs, files in os.walk(DIR):
                                    for file in files:
                                        full_path = os.path.join(root, file)
                                        arcname = os.path.relpath(full_path, os.path.join(DIR, '..'))
                        ...
                        if skinid[:3]==b'526' or skinid[:3]==b'137':
                            os.mkdir(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Prefab_Characters/{decompress}')
                            os.mkdir(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Prefab_Characters/{decompress}_pet')
                            with open(f'./Pmin_Sources/Resources/1.62.1/Prefab_Characters/Prefab_Pet/{decompress}_Pet/{decompress}_Pet_actorinfo.bytes','rb') as f:a=f.read()
                            if skinid[:3]==b'526':
                                a=decompress_(a,ZSTD_DICT)
                            ...
                            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Prefab_Characters/{decompress}_pet/{decompress}_Pet_actorinfo.bytes','wb') as f:f.write(a)
                            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Prefab_Characters/Prefab_Hero/{decompress}/{decompress}_actorinfo.bytes','rb') as f:
                                a=f.read()
                                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Prefab_Characters/{decompress}/{decompress}_actorinfo.bytes','wb') as f:
                                    f.write(a)
                            def zipdir3(path, ziph):
                                for ii in [decompress,f'{decompress}_pet']:
                                    nonee = './{}'.format(ii)
                                    DIR2 = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Prefab_Characters/{}'.format(folder_mod,ii)
                                    DIR = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Prefab_Characters/{}'.format(folder_mod,ii)
                                    for root, dirs, files in os.walk(DIR):
                                        for file in files:
                                            full_path = os.path.join(root, file)
                                            arcname = os.path.relpath(full_path, os.path.join(DIR, '..'))
                                            ziph.write(full_path,arcname)
                            with zipfile.ZipFile('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Prefab_Characters/Actor_{}_Infos.pkg.bytes'.format(folder_mod,decompress[:3]), 'w', zipfile.ZIP_STORED) as zipf:
                                zipdir3('tmp/', zipf)
                            for file in listdir(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Prefab_Characters/'):
                                if 'bytes' not in file:
                                    shutil.rmtree(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Prefab_Characters/{file}')
                        if skinid[:3]!=b'526' and skinid[:3]!=b'137':
                            DIR = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress)
                            DIR2 = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress)
                            nonee = './Prefab_Hero/{}'.format(decompress)
                            with zipfile.ZipFile('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Prefab_Characters/Actor_{}_Infos.pkg.bytes'.format(folder_mod,hero_name[:3].decode()), 'w', zipfile.ZIP_STORED) as zipf:
                                zipdir('tmp/', zipf)
                        if os.path.isdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress))== 1 :
                            shutil.rmtree('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress))
                        if skinid[:3]!=b'526' and skinid[:3]!=b'137':
                            if os.path.isdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Prefab_Characters/Prefab_Hero'.format(folder_mod))== 1 :
                                shutil.rmtree('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Prefab_Characters/Prefab_Hero'.format(folder_mod))
                except:pass
            #----------------------------------Mod Motion--------------------------------------------#
                print('Mod Motion')
                try:
                    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Motion/ResSkinMotionBaseCfg.bytes','rb') as f:
                        strin=f.read()
                        ID=skinid.decode()
                        List=[]
                        for i in range(30):
                        ...
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Motion/ResSkinMotionBaseCfg.bytes','wb') as f:f.write(strin)
                except:
                    print('\033[1;33mKhong Mod Motion')
                if skinid in [b'54402']:
                    if os.path.isdir(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Gear')== 0 :
                        shutil.copytree(f'./Pmin_Sources/resources/1.62.1/ages/prefab_gear',f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Gear')
                    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Gear/Defense/1338E1.xml','rb') as f:
                        strin=f.read()
                        strin=decompress_(strin,ZSTD_DICT)
                        ...
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Gear/Defense/1338E1.xml','wb') as f:
                            f.write(fix_condition(strin))
                    def zipdir6(path, ziph):
                        DIR = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Gear'.format(folder_mod)
                        for root, dirs, files in os.walk(DIR):
                            for file in files:
                                full_path = os.path.join(root, file)
                                arcname = os.path.relpath(full_path, os.path.join(DIR, '..'))
                                ziph.write(full_path,arcname)
                    with zipfile.ZipFile(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Gear.pkg.bytes', 'w', zipfile.ZIP_STORED) as zipf:
                        zipdir6('tmp/', zipf)
                    shutil.rmtree(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Gear')
                ...
                try:
                    ...
                    if True:#find_back>2 and may_yeu_mod and check_bien_ve_ef:
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1.xml','rb') as f:
                            strin = f.read()
                            ...
                            if pos!=-1:
                                ...
                                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1.xml','wb') as f1:
                                    f1.write(strin)
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1_leave.xml','rb') as f:
                            strin = f.read()
                            for code in split_code_back(strin[:strin.find(b'    <Track trackName="CheckHeroId')]):
                                code_goc=code
                                check_Back=b'</Event>'
                            ...
                            ef = ef.replace(b'</Event>',check_Back)
                            strin = strin.replace(b' </Action>',ef+b'\n  </Action>')
                            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1_leave.xml','wb') as f1:
                                f1.write(strin)
                ...
                try:
                    if skinid[:3] in [b'150']:
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Huanhua/ResKillBillboardCfg.bytes','rb') as f:
                            killboard=f.read()
                        ...
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Huanhua/ResKillBillboardCfg.bytes','wb') as f:
                            f.write(killboard)
                except Exception as bug:
                    print(bug)
                #Mod assetrefs
                ...
                try:
                    if True:   
                        ...
                        with open(f'./Pmin_Sources/Resources/1.62.1/AssetRefs/Hero/{file}','rb') as f:
                            strin = f.read()
                            strin=decompress_(strin,ZSTD_DICT)
                            if os.path.isdir(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/AssetRefs/') ==0:
                                os.makedirs(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/AssetRefs/')
                                os.makedirs(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/AssetRefs/Hero/')
                            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/AssetRefs/Hero/{file}','wb') as f1:
                                f1.write(strin)
                        filexml=f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/AssetRefs/Hero/{file}'
                        byt=open(filexml, 'rb')
                        i=0
                        nod={}
                        ofs = getint()
         ...
         <Item Var="Com" Type="AssetRefAnalyser.Pair`2[System.UInt32,System.Int32]">
            ...
            <v2 Var="String" Type="System.Int32">1</v2>
                        ...
                        find_base = xmlstr.find('<baseSubset')
                        if find_base != -1:
                            q = xmlstr.find('</baseSubset>', find_base)
                            base_subset_xml = base_subset_xml_goc = xmlstr[find_base:q + len('</baseSubset>')]
                            for need_mod in ['particlesInFirstLayer', 'hurtParticlesInFirstLayer']:
                                find_need = base_subset_xml.find(f'<{need_mod} ')
                                if find_need != -1:
                                    q = base_subset_xml.find(f'</{need_mod}>', find_need)
                                    need_mod_xml = base_subset_xml[find_need:q + len(f'</{need_mod}>')]
                                    items = tach_item_from_xml(need_mod_xml)
                                    for item_xml in items:
                                        if 'prefab_skill_effects/hero_skill_effects' in item_xml.lower():
                                            item_xml_mod = fix_ef(mod_ef_sound2(item_xml.encode('utf-8'),decompress,skinid),skinid).decode()
                                            base_subset_xml = base_subset_xml.replace(item_xml, item_xml + item_xml_mod)
                            xmlstr = xmlstr.replace(base_subset_xml_goc, base_subset_xml)
                        find_skin = xmlstr.find('<skinSubset')
                        if find_skin != -1:
                            q = xmlstr.find('</skinSubset>', find_skin)
                            skin_subset_xml = skin_subset_xml_goc = xmlstr[find_skin:q + len('</skinSubset>')]
                            for need_mod in ['particlesInFirstLayer', 'hurtParticlesInFirstLayer']:
                                find_need = skin_subset_xml.find(f'<{need_mod} ')
                                if find_need != -1:
                                    q = skin_subset_xml.find(f'</{need_mod}>', find_need)
                                    need_mod_xml = skin_subset_xml[find_need:q + len(f'</{need_mod}>')]
                                    items = tach_item_from_xml(need_mod_xml)
                                    for item_xml in items:
                                        if 'prefab_skill_effects/hero_skill_effects' in item_xml.lower():
                                            item_xml_mod = fix_ef(mod_ef_sound2(item_xml.encode('utf-8'),decompress,skinid),skinid).decode()
                                            skin_subset_xml = skin_subset_xml.replace(item_xml, item_xml + item_xml_mod)
                            xmlstr = xmlstr.replace(skin_subset_xml_goc, skin_subset_xml)
        ...
        if os.path.isfile("unity.py"):
            path = f"File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/assetbundle"
            os.system(f"python unity_pk.py {skinid_phu_kien[:5].decode()} {path}")

    print('kết cục')
    def zipdir2(path, ziph):
        for ii in back_folder:
            DIR2 = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,ii)
            DIR = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,ii)
            for root, dirs, files in os.walk(DIR):
                for file in files:
                    full_path = os.path.join(root, file)
                    arcname = os.path.relpath(full_path, os.path.join(DIR, '..'))
                    ziph.write(full_path,arcname)
    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Back.xml','rb') as f1:strin=f1.read()
    ...
    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1.xml','rb') as f1:strin=f1.read()
    ...
    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1.xml','wb') as f1:
        strin=xoa_thua_thai(strin)
        f1.write(compress_(strin,ZSTD_DICT))
    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1_leave.xml','rb') as f1:strin=f1.read()
    if False:
    ...
    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1_leave.xml','wb') as f1:
        strin=xoa_thua_thai(strin)
        f1.write(compress_(strin,ZSTD_DICT))
    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Born.xml','rb') as f1:strin=f1.read()
    strin=fix_condition(strin)
    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Born.xml','wb') as f1:
        strin=xoa_thua_thai(strin)
        f1.write(compress_(strin,ZSTD_DICT))
    with zipfile.ZipFile('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/CommonActions.pkg.bytes'.format(folder_mod), 'w', zipfile.ZIP_STORED) as zipf:
        zipdir2('tmp/', zipf)
    ...
    for iii in back_folder:
        if os.path.isdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,iii))== 1 :
            shutil.rmtree('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,iii))
    #---------mod ResCharacterComponent.bytes-----
    try:
        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Character/ResCharacterComponent.bytes','rb') as f:
            a=f.read()
            p2=a[:14]
            p3=a[:12]+b'\x00\x00'
            a=a.replace(p2,p3,1)
            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Databin/Client/Character/ResCharacterComponent.bytes','wb') as f:f.write(compress_(a,ZSTD_DICT))
    except:
            ...
            for file in listdir('NutBam'):
                if nut_bam in file:
                    with open(f'Nutbam/{file}','rb') as f:
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/assetbundle/uisystem/atlas/primary/allshared.assetbundle','wb') as f2:
                            f2.write(f.read())
                    break
    except Exception as bug:
        pass
    #chạy mod new update
    try:
        with open(f'Pmin_Sources/Resources/1.62.1/assetbundle/resourceverificationinfosetall.assetbundle','rb') as f:
            strin=f.read()
    except:
    ...
    i=0
    '''for file in listdir(f'Pmin_Sources/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero'):
        if file[:6].lower() == 'actor_' and len(file) == len('Actor_105_Actions.pkg.bytes') and '_Actions.pkg.bytes'.lower() in file.lower():
            with open(f'Pmin_Sources/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{file}','rb') as f2:
                a=f2.read()
                t=f'{100+i}_YTB_Pmin_Mods.pkg.bytes'
                strin=re.sub(file.encode('utf-8'),t.encode('utf-8'),strin, flags = re.IGNORECASE)
                i+=1
            with open(f'File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{t}','wb') as f2:
                f2.write(a)'''
    with open(f'File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.62.1/assetbundle/resourceverificationinfosetall.assetbundle','wb') as f:f.write(strin)
    ...
    if cam_xa_goc!=100:
        ...
        try:
            giai_nen(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/','Actor_530_Actions.pkg.bytes')
            os.mkdir(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak')
            shutil.copytree(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/skill',f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak/skill')
            shutil.rmtree(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/skill')
        except:
            shutil.copytree(f'./Pmin_Sources/resources/1.62.1/ages/Prefab_Characters/Prefab_Hero/530_Dirak',f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak')
        ...
        giai_nen(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/','CommonActions.pkg.bytes')
        with open(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak/skill/P2E1.xml','rb') as f:
            a=f.read()
            a=decompress_(a,ZSTD_DICT)
            p=a.find(b'<Track trackName="')
            a=a[:p]+cam_xa
            with open(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak/skill/P2E1.xml','wb') as f:f.write(compress_(a,ZSTD_DICT))
        with open(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/back.xml','rb') as f:
            a=f.read()
            a=decompress_(a,ZSTD_DICT)
            a=a.replace(b'</Action>',hittringer_dirak)
            with open(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/back.xml','wb') as f:f.write(compress_(a,ZSTD_DICT))
        with open(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/born.xml','rb') as f:
            a=f.read()
            a=decompress_(a,ZSTD_DICT)
            a=a.replace(b'</Action>',hittringer_dirak)
            with open(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/born.xml','wb') as f:f.write(compress_(a,ZSTD_DICT))
        with open(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Heal5v5.xml','rb') as f:
            a=f.read()
            a=decompress_(a,ZSTD_DICT)
            a=a.replace(b'</Action>',hittringer_dirak)
            with open(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Heal5v5.xml','wb') as f:f.write(compress_(a,ZSTD_DICT))
        with open(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Heal3v3.xml','rb') as f:
            a=f.read()
            a=decompress_(a,ZSTD_DICT)
            a=a.replace(b'</Action>',hittringer_dirak)
            with open(f'File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Heal3v3.xml','wb') as f:f.write(compress_(a,ZSTD_DICT))
        DIR = f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak/skill'
        DIR2 = f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak/skill'
        nonee = './530_Dirak/skill'
        with zipfile.ZipFile(f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/Actor_530_Actions.pkg.bytes', 'w', zipfile.ZIP_STORED) as zipf:
            zipdir('tmp/', zipf)
        def zipdir_camxa(path, ziph):
            for ii in back_folder:
                nonee = './{}'.format(ii)
                DIR2 = f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{ii}'
                DIR = f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{ii}'
                for root, dirs, files in os.walk(DIR):
                    for file in files:
                        full_path = os.path.join(root, file)
                        arcname = os.path.relpath(full_path, os.path.join(DIR, '..'))
                        ziph.write(full_path,arcname)
        with zipfile.ZipFile(f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/CommonActions.pkg.bytes', 'w', zipfile.ZIP_STORED) as zipf:
            zipdir_camxa('tmp/', zipf)
        if os.path.isdir(f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak')== 1 :
            shutil.rmtree(f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak')
        for iii in back_folder:
            if os.path.isdir(f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{iii}')== 1 :
                shutil.rmtree(f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{iii}')
    if nut_bam_auto_mod!='':
...
if False:
    if not only_cam_xa:
        ...
        #Máy Mạnh
        tien_trinh_dem = tien_trinh(tien_trinh_dem)
        #if os.path.isdir(f'./File_Mod/{folder_mod}/Máy Mạnh/Android/Resources/1.62.1/AssetRefs') == 1 :
        #    shutil.rmtree(f'./File_Mod/{folder_mod}/Máy Mạnh/Android/Resources/1.62.1/AssetRefs')
        tien_trinh_dem = tien_trinh(tien_trinh_dem)
        shutil.make_archive(f'./File_Mod/{folder_mod}/Máy Mạnh/IOS/Resources','zip',f'./File_Mod/{folder_mod}/Máy Mạnh/Android')
        #Máy Trung Và Yếu
        tien_trinh_dem = tien_trinh(tien_trinh_dem)
        giai_nen(f'./File_Mod/{folder_mod}/Máy Trung Và Yếu/Android/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/','CommonActions.pkg.bytes')
        tien_trinh_dem = tien_trinh(tien_trinh_dem)
        for file in ['Back.xml','HasteE1.xml','HasteE1_leave.xml','born.xml']:
            with open(f'pmin_sources/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/{file}','rb') as f:
                a=f.read()
            with open(f'File_Mod/{folder_mod}/Máy Trung Và Yếu/Android/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/{file}','wb') as f:
                f.write(a)
        tien_trinh_dem = tien_trinh(tien_trinh_dem)
        tien_trinh_dem = tien_trinh(tien_trinh_dem)
        back_folder = ['commonresource','KeySpell','PassiveResource','mowen','Ultrafire','SeasonPlay']
        def zipdir2(path, ziph):
                for ii in back_folder:
                    nonee = './{}'.format(ii)
                    DIR2 = './File_Mod/{}/Máy Trung Và Yếu/Android/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,ii)
                    DIR = './File_Mod/{}/Máy Trung Và Yếu/Android/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,ii)
                    for root, dirs, files in os.walk(DIR):
                        for file in files:
                            full_path = os.path.join(root, file)
                            arcname = os.path.relpath(full_path, os.path.join(DIR, '..'))
                            ziph.write(full_path,arcname)
        tien_trinh_dem = tien_trinh(tien_trinh_dem)
        with zipfile.ZipFile('./File_Mod/{}/Máy Trung Và Yếu/Android/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/CommonActions.pkg.bytes'.format(folder_mod), 'w', zipfile.ZIP_STORED) as zipf:
                zipdir2('tmp/', zipf)
                tien_trinh_dem = tien_trinh(tien_trinh_dem)
        for iii in back_folder:
                tien_trinh_dem = tien_trinh(tien_trinh_dem)
                if os.path.isdir('./File_Mod/{}/Máy Trung Và Yếu/Android/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,iii))== 1 :
                    tien_trinh_dem = tien_trinh(tien_trinh_dem)
                    shutil.rmtree('./File_Mod/{}/Máy Trung Và Yếu/Android/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,iii))
        ...
        if checkCamXa!='NamNgu':
            ...
            #Máy Mạnh
            tien_trinh_dem = tien_trinh(tien_trinh_dem)
            if os.path.isdir(f'./File_Mod/{folder_mod}/{checkCamXa}/Máy Mạnh/Android/Resources/1.62.1/AssetRefs') == 1 :
                tien_trinh_dem = tien_trinh(tien_trinh_dem)
                tien_trinh_dem = tien_trinh(tien_trinh_dem)
            ...
            #Máy Trung Và Yếu
            tien_trinh_dem = tien_trinh(tien_trinh_dem)
            giai_nen(f'./File_Mod/{folder_mod}/{checkCamXa}/Máy Trung Và Yếu/Android/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/','CommonActions.pkg.bytes')
            tien_trinh_dem = tien_trinh(tien_trinh_dem)
            for file in ['Back.xml','HasteE1.xml','HasteE1_leave.xml','born.xml']:
                with open(f'pmin_sources/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/{file}','rb') as f:
                    a=f.read()
                    ...
                    tien_trinh_dem = tien_trinh(tien_trinh_dem)
                with open(f'File_Mod/{folder_mod}/{checkCamXa}/Máy Trung Và Yếu/Android/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/{file}','wb') as f:
                    tien_trinh_dem = tien_trinh(tien_trinh_dem)
            ...
            def zipdir2(path, ziph):
                    for ii in back_folder:
                        nonee = './{}'.format(ii)
                        DIR2 = './File_Mod/{}/{}/Máy Trung Và Yếu/Android/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,checkCamXa,ii)
                        DIR = './File_Mod/{}/{}/Máy Trung Và Yếu/Android/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,checkCamXa,ii)
                        for root, dirs, files in os.walk(DIR):
                            for file in files:
                                full_path = os.path.join(root, file)
                                arcname = os.path.relpath(full_path, os.path.join(DIR, '..'))
                                ziph.write(full_path,arcname)
            with zipfile.ZipFile('./File_Mod/{}/{}/Máy Trung Và Yếu/Android/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/CommonActions.pkg.bytes'.format(folder_mod,checkCamXa), 'w', zipfile.ZIP_STORED) as zipf:
                    zipdir2('tmp/', zipf)
                    tien_trinh_dem = tien_trinh(tien_trinh_dem)
            for iii in back_folder:
                    tien_trinh_dem = tien_trinh(tien_trinh_dem)
                    if os.path.isdir('./File_Mod/{}/{}/Máy Trung Và Yếu/Android/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,checkCamXa,iii))== 1 :
                        tien_trinh_dem = tien_trinh(tien_trinh_dem)
                        shutil.rmtree('./File_Mod/{}/{}/Máy Trung Và Yếu/Android/Resources/1.62.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,checkCamXa,iii))
                        tien_trinh_dem = tien_trinh(tien_trinh_dem)
